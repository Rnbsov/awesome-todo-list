  ...
  return (
    ...
    >
      ...
      <div className='flex items-center justify-center gap-x-4 lg:gap-x-6'>
        ...
        <button className='w-8 h-8 bg-gradient-to-tr from-cl1 to-cl2 flex justify-center items-center rounded-lg text-white transition-transform duration-300 ease-in-out hover:scale-110'>
          <Plus size={24} />
        </button>
